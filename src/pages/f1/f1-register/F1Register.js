...
function F1Register() {
  ...
  return (
    <>
      ...
      <S.Section>
        <F1FormContainer onSubmit={handleSubmit(sendSubmission)}>
          {showConfirmation === false ? (
            <>
              ...
              {errors.playerID && <h6>Please provide your player ID</h6>}
              <select
              name="platform"
              ...
              {errors.platform && <h6>Please select a platform</h6>}
              <input
                name="discordTag"
                {...register("discordTag", { required: true })}
                value={discordTag}
                onChange={(e) => setDiscordTag(e.target.value)}
                type="text"
                placeholder="Discord tag"
              />
              {errors.discordTag && <h6>Please provide your Discord Tag</h6>}
              <select
                name="nationality"
              ...
              {errors.nationality && <h6>Please select a nationality</h6>}
